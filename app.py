...
PURCHASE_COST_MAP = {
    ...
    # 550 Cost SKUs
    clean_sku("HB-103 INDIGO NEW"): 475,
    clean_sku("HB-103 RAMA NEW"): 475,
    clean_sku("HB-103 WINE NEW"): 475,
    clean_sku("HB-103 PINK NEW"): 475,
    clean_sku("HB-103 YELLOW NEW"): 475,

    clean_sku("HB-103 RAMA"): 475,
    clean_sku("HB-103 YELLOW"): 475,
    clean_sku("HB-103 PURPLE"): 475,
    clean_sku("HB-103 PINK"): 475,
    clean_sku("HB-103 INDIGO"): 475,
