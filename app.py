...
PURCHASE_COST_MAP = {
    clean_sku("MirrorBlue1"): 650,
    clean_sku("HIRVA-221 PURPLE NEW 1299"): 650,
    clean_sku("HB-221 Purple"): 650,
    clean_sku("HB-221 Red"): 650,
    clean_sku("HIRVA-221 RED NEW 1299"): 650,
    clean_sku("mirror - blue"): 650,
    clean_sku("MIRROR YELLOW"): 650,

    clean_sku("PS124 Black"): 550,
    clean_sku("PS124 Pink"): 550,
    clean_sku("PS124 Rama"): 550,

    clean_sku("HB-103 INDIGO NEW"): 500,
    clean_sku("HB-103 RAMA NEW"): 500,
    clean_sku("HB-103 WINE NEW"): 500,
    clean_sku("HB-103 PINK NEW"): 500,
    clean_sku("HB-103 YELLOW NEW"): 500,
    clean_sku("HB-103 RAMA"): 500,
    clean_sku("HB-103 YELLOW"): 500,
    clean_sku("HB-103 PURPLE"): 500,
    clean_sku("HB-103 PINK"): 500,
    clean_sku("HB-103 INDIGO"): 500,

    clean_sku("BH-221 Red NEW 1299"): 650,
    clean_sku("221-Unstiched-Purple"): 480,
    clean_sku("221 Red XXL"): 650,
    clean_sku("221 Purple XXL"): 650,
    clean_sku("221 Red"): 650,
    clean_sku("221 Purple"): 650,
    clean_sku("H-201 maroon"): 550,
    clean_sku("BH-221 Purple NEW 1299"): 650,
